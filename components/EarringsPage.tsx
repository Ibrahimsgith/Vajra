...
export const EarringsPage: React.FC<EarringsPageProps> = ({ products, onAddToCart, onToggleWishlist, onViewProduct, wishlistItems }) => {
  const earrings = products.filter(p => p.productType === 'Earrings');
